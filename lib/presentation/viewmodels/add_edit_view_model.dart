import 'package:app_descuento/data/models/discount.dart';
import 'package:app_descuento/domain/use_cases/delete_discount_use_case.dart';
import 'package:app_descuento/domain/use_cases/save_discount_use_case.dart';
import 'package:app_descuento/presentation/viewmodels/home_view_model.dart';
...
class AddEditViewModel extends ChangeNotifier {
  ...
  Future<bool> save({
    ...
    try {
      ...
      _errorMessage = 'Error al guardar descuento: $e';
